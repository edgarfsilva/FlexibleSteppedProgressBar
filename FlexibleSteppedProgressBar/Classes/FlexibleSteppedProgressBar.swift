...
@IBDesignable open class FlexibleSteppedProgressBar: UIView {
    ...
    @IBInspectable open var currentSelectedCenterColor: UIColor = UIColor(red: 0, green: 0, blue: 0, alpha: 1.0) {
        didSet {
            self.setNeedsDisplay()
        }
    }
    ...
    @IBInspectable open var selectedOuterCircleStrokeColor: UIColor = UIColor(red: 0, green: 0, blue: 0, alpha: 1.0) {
        didSet {
            self.setNeedsDisplay()
        }
    }
    ...
    @IBInspectable open var centerLayerPassedTextColor: UIColor = UIColor(red: 0, green: 0, blue: 0, alpha: 1.0) {
        didSet {
            self.setNeedsDisplay()
        }
    }
    ...
    fileprivate func renderTextIndexes() {
        ...
        for i in 0...(numberOfPoints - 1) {
            ...
            if i == currentIndex || i == completedTillIndex {
                ...
                if i < currentIndex {
                    textLayer.foregroundColor = centerLayerPassedTextColor.cgColor
                } else {
