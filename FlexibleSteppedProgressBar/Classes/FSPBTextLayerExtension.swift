...
extension CATextLayer {
    ...
    func sizeWidthToFit() {
        ...
        var attString = NSAttributedString(string: "", attributes: attributes as? [String : AnyObject])
        
        if self.string != nil {
            attString = NSAttributedString(string: self.string as! String, attributes: attributes as? [String : AnyObject])
        }
